...
@property (nonatomic, weak) id <RIOInterfaceDelegate> delegate;

@property(nonatomic, weak) id<AVAudioPlayerDelegate> audioPlayerDelegate;
@property(nonatomic, weak) id<AVAudioSessionDelegate> audioSessionDelegate;
